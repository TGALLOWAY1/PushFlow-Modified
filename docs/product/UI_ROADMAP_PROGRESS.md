...
- **2026-09-24 · S1a.3 · Engine placeholder names use pitch.** `buildVoiceMap` names a Sound it was told nothing about `Sound <pitch>`; this is reachable only for Sound-less synthetic events (the app always passes its Sounds as hints). Belongs to: S2.2a (Q3 naming), if the placeholder ever reaches the UI.
