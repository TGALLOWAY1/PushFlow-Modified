...
- **2026-09-25 · S2.1 · The transport position still reads seconds.** It is a fixed 56 px box showing "4.56s"; S2.2b's musical notation makes it bar.beat.sixteenth and shows the effective BPM beside Speed. Belongs to: S2.2b.
- **2026-09-25 · S2.2a · Timeline pill text can be unreadable on light Sound colours.** Pill text is coloured by hand (a light tint), so on the yellow, aqua, peach, mint and lavender palette colours it has little contrast (T64's "hand-tinted pill text on amber 2.3:1", now on more colours). Belongs to: S2.2b (readability floor).
